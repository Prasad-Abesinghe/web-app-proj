    ...
    <div className=" px-4 lg:px-24 w-full flex-col justify-between md:flex-row flex items-center py-40">
        <div className="  md:w-1/2 space-y-8 h-full">
          <h2 className=" text-5xl font-bold leading-snug text-slate-300">
            Buy a <br />{" "}
            <span className=" font-bold bg-gradient-to-r from-orange-500 to-orange-800 bg-clip-text text-transparent">Good Mobile Phone </span> <br />
            For the <br />
            <span className=" font-bold bg-gradient-to-r from-orange-500 to-orange-800 bg-clip-text text-transparent"> Best Prices</span>
          </h2>
